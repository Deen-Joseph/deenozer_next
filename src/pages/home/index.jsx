      ...
      <div className={styles.home}>
        ...
        <section className="bg-white border-b py-8">
          <div className="container max-w-5xl mx-auto m-8">
            <h2 className="w-full my-2 text-5xl font-bold italic leading-tight text-center text-gray-800">
              Deenozer.com
            </h2>
            ...
            <div className="flex flex-wrap">
              <div className="w-5/6 sm:w-1/2 p-6">
                <h3 className="text-3xl text-gray-800 font-bold leading-none mb-3">
                  Largest Football Database
                </h3>
                <p className="text-gray-600 mb-8">
                  Latest Details, About and Stats Players, Clubs and Football
                  Associations with Logos. here are many variations of passages
            ...
            <div className="flex flex-wrap flex-col-reverse sm:flex-row">
              ...
              <div className="w-full sm:w-1/2 p-6 mt-6">
                <div className="align-middle">
                  ...
                  <p className="text-gray-600 mb-8">
                    Vast database of football all around Globe here are many
          ...
          <div className="container mx-auto flex flex-wrap pt-4 pb-12">
            ...
            <div className="w-full md:w-1/3 p-6 flex flex-col flex-grow flex-shrink">
              <div className="flex-1 bg-white rounded-t rounded-b-none overflow-hidden shadow">
                ...
                >
                  <p className="w-full text-gray-600 text-lg font-bold md:text-lg px-6">
                    Players
                  </p>
                  <div className="w-full font-bold text-xl text-gray-800 px-6">
                    Details of your Favorite Players.
                  </div>
            ...
            <div className="w-full md:w-1/3 p-6 flex flex-col flex-grow flex-shrink">
              <div className="flex-1 bg-white rounded-t rounded-b-none overflow-hidden shadow">
                <a
                  ...
                  className="flex flex-wrap no-underline hover:no-underline"
                >
                  <p className="w-full text-gray-600 text-lg md:text-lg font-bold px-6">
                    Clubs
                  </p>
                  <div className="w-full font-bold text-xl text-gray-800 px-6">
                    Details of your Favorite Clubs.
                  </div>
                  <p className="text-gray-800 text-base px-6 mb-5">
                    Lorem ipsum dolor sit amet, consectetur adipiscing elit.
                    Aliquam at ipsum eu nunc commodo posuere et sit amet ligula.
            ...
            <div className="w-full md:w-1/3 p-6 flex flex-col flex-grow flex-shrink">
              <div className="flex-1 bg-white rounded-t rounded-b-none overflow-hidden shadow">
                ...
                >
                  ...
                  <div className="w-full font-bold text-xl text-gray-800 px-6">
                    Details of your Favorite Football Associations.
                  </div>
                  <p className="text-gray-800 text-base px-6 mb-5">
                    Lorem ipsum dolor sit amet, consectetur adipiscing elit.
                    Aliquam at ipsum eu nunc commodo posuere et sit amet ligula.
